...
from esr.fitting.sympy_symbols import y as _fprint_y_sym
...
_FPRINT_Y_POINTS = _FPRINT_RNG.uniform(0.2, 5.0, _FPRINT_N_POINTS)
...
def numerical_fingerprint(expr, max_param=None):
    ...
    has_y = _fprint_y_sym in expr.free_symbols
    ...
    if has_y:
        call_args.append(_FPRINT_Y_POINTS)
